...
if ($searchSubmit) {
    ...
    if ($request == 'training_institute') {
        $dataset['batch_info'] = prepareBatchData($sectorName, $courseId, $location, $trainingPartner, $courseId, $trainingInstitute);
    }
}
...
function prepareBatchData($sectorName = null, $courseId = null, $location = null, $trainingPartner = null, $courseTitle = null, $trainingInstitute = null)
{
    $sql = "SELECT i.id, i.institute_name, c.course_name, i.present_address,  i.web_url, i.phone, i.email
...
AND b.active_status=1 ";
    ...
    if (!empty($courseTitle)) {
        $sql .= " AND c.course_name LIKE '%$courseTitle%' ";
    }
