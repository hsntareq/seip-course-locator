...
function the_breadcrumb()
{
  ...
  if (is_home() || is_front_page()) {
    if ($showOnHome == 1) {
      echo '<nav aria-label="breadcrumb"><ol class="breadcrumb bg-white p-0 mb-0"><li class="breadcrumb-item"><a href="' . $homeLink . '">' . $home . '</a></li></ol></nav>';
    }
  } else {
    echo '<nav aria-label="breadcrumb"><ol class="breadcrumb bg-white p-0 mb-0"><li class="breadcrumb-item"><a href="' . $homeLink . '">' . $home . '</a></li>';
    if (is_category()) {
